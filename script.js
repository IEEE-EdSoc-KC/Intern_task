...
document.addEventListener('DOMContentLoaded', function () {
    // Typewriter effect
    //cursor tracking
    const cursorTrack = document.getElementById('cursorTracker');
  document.addEventListener('mousemove', function (e) {
        //accesing cursor axes
        cursorTrack.style.left=`${e.clientX}px`;
        cursorTrack.style.top=`${e.clientY}px`;

        let cursorLeft = cursorTrack.offsetLeft;
